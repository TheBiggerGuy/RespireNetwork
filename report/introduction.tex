...
life-signs has been a recurring theme in science fiction for years\citer{StarTrekStarFleetTechnicalManual1986}, but only recently have
...
dollar prize for a ``Tricorder''\citer{XprizeHealth2012} and new research into ways of measuring and analysing vital
signs.
...
and, in a broader context, for small  consumer-electronics fitness aids\citer{Jawbone2012, Fitbit2012}.
...
in motion capture and general research. These Orient\citer{Orient2012} and ProSpeckz\citer{ProSpeckz2012} devices
...
\begin{wrapfigure}{r}{0.3\textwidth}
  ...
  \end{center}
  \caption[Face Mask]{Face mask\citer{FaceMaskImg}}
  \vspace{-10pt}
\end{wrapfigure}
...
these systems are both invasive and uncomfortable for the patient\citer{NasalCannula2011}. Whilst accurate, they
...
\begin{wrapfigure}{l}{0.3\textwidth}
  ...
  \end{center}
  \caption[Nasal Cannula]{Nasal cannula\citer{SpecknetFlyer}}
  \vspace{-10pt}
\end{wrapfigure}
...
Edinburgh team who designed the Respire device\citer{BatesLingMannArvind2010}. This non-invasive
...
accelerometers\citer{ZhaoZhaoQun2008, BoyleBidargaddiSarelaKarunanithi2009}.
...
terms\citer{Hunter2008}. It however is an increasing field of study, as with the availability of continuous measuring
...
condition whilst the patients can be alerted of their onset, thus preventing harm\citer{5334605}.
