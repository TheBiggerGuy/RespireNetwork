...
%% abstract
\abstract{
The Respire device provides unobtrusive respiratory monitoring of patients by use of
...
disease.
The aim of this project was to develop Respire network firmware based on TDMA to
allow use in large hospital environments.
I produced, tested and debugged firmware for project, which led to identification
of problems implementing TDMA with the Send-Receive function of the low-power
nRF24L01+ onboard the Respire device. This has precluded testing of my design with the Respire
devices in a large-network environment.
A base of reusable system modules was produced which will be able to support later
development of the Respire platform.
}
...
\include{background}
\include{design}
\include{implementation_and_testing}
\include{discussion}
\include{conclusion}
...
%% chapter files.
\appendix
\include{test_rx_tx_only}
\include{code_analysis}
